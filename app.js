...
(function($PS) {
  ...
  var exports = $PS["Data.ModularArithmetic.Primality"];
  var Data_Eq = $PS["Data.Eq"];
          ...
          return function ($copy_v) {
              return function ($copy_v1) {
                  ...
                  function $tco_loop(factors, v, v1) {
                      ...
                      var $10 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v1)(v) === 0;
                      if ($10) {
                          $tco_var_factors = new Data_List_Types.Cons(v, factors);
                          $tco_var_v = v;
                          $copy_v1 = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(v1)(v);
                          return;
                      };
...
(function($PS) {
  ...
  var exports = $PS["LegendreSymbols"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var emod = function (x) {
      return function (m) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(x)(m) + m | 0)(m);
      };
  };
  ...
  var reduce = function (v) {
      ...
      if (v.value0 === (v.value1 - 1 | 0)) {
          var e = (function () {
              var $130 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v.value1)(4) === 1;
              if ($130) {
                  return lit(1);
              };
              return lit(-1 | 0);
      ...
      if (v.value0 === 2) {
          var r = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v.value1)(8);
          var e = (function () {
              var $131 = r === 1 || r === 7;
              if ($131) {
                  return lit(1);
      ...
      if (Data_ModularArithmetic_Primality.isPrime(v.value0)) {
          var e = (function () {
              var $132 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v.value1)(4) === 3 && Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v.value0)(4) === 3;
              if ($132) {
      ...
      if ($139 instanceof Data_Maybe.Just) {
          var e = (function () {
              var $140 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)($139.value0.value1)(2) === 0;
              if ($140) {
                  return lit(1);
              };
...
(function($PS) {
  ...
  var isOddPrime = function (p) {
      return Data_ModularArithmetic_Primality.isPrime(p) && p > 2;
  };
  var updateStateFromInputs = function (state) {
      var newInput = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Int.fromString(state.numerator))(function (v) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Int.fromString(state.denominator))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Data_Maybe.bindMaybe)(Control_MonadZero.guard(Data_Maybe.monadZeroMaybe)(isOddPrime(v1)))(function () {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new Data_Tuple.Tuple(v, v1));
              });
          });
      });
      return Data_Maybe.maybe(state)(stateFromInput)(newInput);
  };
  var component = (function () {
      var validateInputWith = function (elId) {
          return function (validate) {
              return function (value) {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                      var v = Data_Functor.map(Effect.functorEffect)(Web_HTML_HTMLDocument.toNonElementParentNode)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document))();
                      var v1 = Web_DOM_NonElementParentNode.getElementById(elId)(v)();
                      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(v1)(Web_HTML_HTMLInputElement.fromElement))(function (el) {
                          return Web_HTML_HTMLInputElement.setCustomValidity(validate(value))(el);
                      })();
                  });
              };
          };
      };
      var validateNumerator = validateInputWith("numerator")(function (value) {
          var v = Data_Int.fromString(value);
          if (v instanceof Data_Maybe.Just) {
              return "";
          };
          if (v instanceof Data_Maybe.Nothing) {
              return "The numerator must be an integer.";
          };
          throw new Error("Failed pattern match at Component (line 184, column 7 - line 188, column 3): " + [ v.constructor.name ]);
      });
      ...
      var render = function (state) {
          ...
          var workingPlain = Data_String_Common.joinWith("\x0a  = ")(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_List_Types.Cons.create(LegendreSymbols.exprToString(reductions.initial))(Data_Functor.map(Data_List_Types.functorList)(function (v) {
              return LegendreSymbols.exprToString(v.value1) + ("     (by " + (Data_String_CodePoints.drop(4)(Data_Show.show(LegendreSymbols.showReductionRule)(v.value0)) + ")"));
          })(reductions.steps))));
          var isComplete = (function (v) {
              return Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(v)(new Data_Maybe.Just(true));
          })(Data_Functor.map(Data_Maybe.functorMaybe)(function ($40) {
              return LegendreSymbols.isFullyReduced(Data_Tuple.snd($40));
          ...
          var inputForm = Halogen_HTML_Elements.form([ Halogen_HTML_Properties.attr("onsubmit")("return false") ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Is") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_("numerator"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.title("Numerator"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(Data_Tuple.fst(state.input))), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateNumerator.create)) ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("a quadratic residue modulo") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_("denominator"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.title("Denominator"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(Data_Tuple.snd(state.input))), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateDenominator.create)) ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("?") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Halogen_HTML_Properties.value("Let's find out!"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ReplaceInput.create)) ]) ]);
      ...
      var validateDenominator = validateInputWith("denominator")(function (value) {
          var v = Data_Int.fromString(value);
          if (v instanceof Data_Maybe.Nothing) {
              return "The denominator must be an integer.";
          };
          if (v instanceof Data_Maybe.Just) {
              var $22 = isOddPrime(v.value0);
              if ($22) {
                  return "";
              };
              return "The denominator must be an odd prime.";
          };
          throw new Error("Failed pattern match at Component (line 191, column 7 - line 197, column 18): " + [ v.constructor.name ]);
      });
      var $$eval = function (v) {
          if (v instanceof Advance) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $25.reductions = s.reductions + 1 | 0;
                  return $25;
              }))(function () {
          ...
          if (v instanceof ReplaceInput) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateStateFromInputs))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof UpdateNumerator) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(validateNumerator(v.value0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      var $30 = {};
                      for (var $31 in s) {
          ...
          if (v instanceof UpdateDenominator) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(validateDenominator(v.value0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      var $35 = {};
                      for (var $36 in s) {
          ...
          throw new Error("Failed pattern match at Component (line 149, column 10 - line 163, column 16): " + [ v.constructor.name ]);
      };
  ...
  exports["isOddPrime"] = isOddPrime;
  exports["updateStateFromInputs"] = updateStateFromInputs;
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(selector))(function (v) {
          if (v instanceof Data_Maybe.Just) {
              return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(Component.component)(Data_Unit.unit)(v.value0));
          };
          if (v instanceof Data_Maybe.Nothing) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.error("Unable to find #app element"));
          };
          throw new Error("Failed pattern match at Main (line 20, column 3 - line 24, column 54): " + [ v.constructor.name ]);
      });
  }));
