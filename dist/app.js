...
(function(exports) {
  ...
  var updateInput = function (state) {
      ...
      return Data_Either.either(function (err) {
          return {
              validationError: new Data_Maybe.Just(err),
  ...
  var component = (function () {
      var render = function (state) {
          ...
          })(Data_Functor.map(Data_Maybe.functorMaybe)(function ($30) {
              return LegendreSymbols.isFullyReduced(Data_Tuple.snd($30));
          ...
          var inputForm = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("input-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Is") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.title("Numerator"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(Data_Tuple.fst(state.input))), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateNumerator.create)) ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("a quadratic residue modulo") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.title("Denominator"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(Data_Tuple.snd(state.input))), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateDenominator.create)) ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("?") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("Let's find out!"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ReplaceInput.create)) ])([ Halogen_HTML_Core.text("Let's find out!") ]) ])(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(renderValidationError)(state.validationError))));
      ...
      var $$eval = function (v) {
          if (v instanceof Advance) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $15.reductions = s.reductions + 1 | 0;
                  return $15;
              }))(function () {
          ...
          if (v instanceof ReplaceInput) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateInput))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          ...
          if (v instanceof UpdateDenominator) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $25.denominator = v.value0;
                  return $25;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          throw new Error("Failed pattern match at Component line 136, column 10 - line 148, column 12: " + [ v.constructor.name ]);
      };
